...
<head>
    ...
    <link href="<?= base_url()?>assets/template2/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <?php $this->load->view('component/menu-user') ?>
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <?php $this->load->view('component/topbar-user'); ?>
                <!-- End of Topbar -->
            ...
            <!-- Footer -->
            <?php $this->load->view('component/footer-user') ?>
            <!-- End of Footer -->
    ...
    <a class="scroll-to-top rounded" href="<?= base_url()?>assets/template2/#page-top">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Pilih "Logout" untuk keluar akun, dan "Cancel" untuk kembali.</div>
    ...
    <!-- Page level plugins -->
    <script src="<?= base_url()?>assets/template2/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="<?= base_url()?>assets/template2/vendor/datatables/dataTables.bootstrap4.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?= base_url()?>assets/template2/js/demo/datatables-demo.js"></script>
