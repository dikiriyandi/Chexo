    ...
    <div class="row">
        ...
        <?php $no=1; foreach ($kelas as $kelas): ?>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <a href="<?= base_url()?>user/Kelas/detail/<?= $kelas['kels_id'] ?>" class="hover-kelas">
                    <div class="card <?php if($no == 1) echo 'border-left-warning'; elseif($no == 2) echo 'border-left-danger'; else echo 'border-left-primary'; ?> shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold <?php if($no == 1) echo 'text-warning'; elseif($no == 2) echo 'text-danger'; else echo 'text-primary'; ?> text-uppercase mb-1">
                                        <?= $kelas['nama_guru'] ?></div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $kelas['kels_nama'] ?></div>
                                </div>
                                <div class="col-auto">
