        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body" id="soal">
                ...
                <?php foreach ($soal_1 as $soal_1): ?>
                    <h5>Pertanyaan No.<?= (int)$uri_segment + 1; ?></h5>
                    <hr>
                    <div>
                        <?= $soal_1['lade_soal'] ?>
                    </div>
                    ...
                    <?php $status_jawaban = TRUE; ?>
                        <?php if(!empty($this->session->userdata('jawaban_sementara'))) : ?>
                            ...
                            <?php foreach($this->session->userdata('jawaban_sementara') as $jawaban_sementara) : ?>
                                ...
                                <?php if($jawaban_sementara['id_soal'] === $soal_1['lade_lath_id']) : ?> 
                                    <?php $status_jawaban = TRUE; ?>
                                    ...
                                    <div class="p-2">
                                        <table>
                                            <tr>
                                                <td>
                                                    <a data-id="<?= $id ?>" data-soal-id="<?= $soal_1['lade_lath_id'] ?>" data-jawaban="a" class="btn <?= ($jawaban_sementara['data']['jawab'] === 'a') ? 'btn-primary' : 'btn-default' ; ?> btn-circle border">A</a>
                                                </td>
                                                <td><?= $soal_1['lade_jawaban_a'] ?></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="p-2">
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <a data-id="<?= $id ?>" data-soal-id="<?= $soal_1['lade_lath_id'] ?>" data-jawaban="b" class="btn <?= ($jawaban_sementara['data']['jawab'] === 'b') ? 'btn-primary' : 'btn-default' ; ?> btn-circle border">B</a>
                                                </td>
                                                <td><?= $soal_1['lade_jawaban_b'] ?></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="p-2">
                                        <table>
                                            <tr>
                                                <td>
                                                    <a data-id="<?= $id ?>" data-soal-id="<?= $soal_1['lade_lath_id'] ?>" data-jawaban="c" class="btn <?= ($jawaban_sementara['data']['jawab'] === 'c') ? 'btn-primary' : 'btn-default' ; ?> btn-circle border">C</a>
                                                </td>
                                                <td><?= $soal_1['lade_jawaban_c'] ?></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="p-2">
                                        <table>
                                            <tr>
                                                <td>
                                                    <a data-id="<?= $id ?>" data-soal-id="<?= $soal_1['lade_lath_id'] ?>" data-jawaban="d" class="btn <?= ($jawaban_sementara['data']['jawab'] === 'd') ? 'btn-primary' : 'btn-default' ; ?> btn-circle border">D</a>
                                                </td>
                                                <td><?= $soal_1['lade_jawaban_d'] ?></td>
                                            </tr>
                                        </table>
                                    </div>
                        ...
                        <?php if($status_jawaban === FALSE) : ?>
                            <div class="p-2">
                                        <table>
                                            <tr>
                                                <td>
                                                    <a data-id="<?= $id ?>" data-soal-id="<?= $soal_1['lade_lath_id'] ?>" data-jawaban="a" class="btn btn-default btn-circle border">A</a>
                                                </td>
                                                    <td><?= $soal_1['lade_jawaban_a'] ?></td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="p-2">
                                        <table>
                                            <tr>
                                                <td>
                                                    <a data-id="<?= $id ?>" data-soal-id="<?= $soal_1['lade_lath_id'] ?>" data-jawaban="b" class="btn btn-default btn-circle border">B</a>
                                                </td>
                                                    <td><?= $soal_1['lade_jawaban_b'] ?></td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="p-2">
                                        <table>
                                            <tr>
                                                <td>
                                                    <a data-id="<?= $id ?>" data-soal-id="<?= $soal_1['lade_lath_id'] ?>" data-jawaban="c" class="btn btn-default btn-circle border">C</a>
                                                </td>
                                                    <td><?= $soal_1['lade_jawaban_c'] ?></td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="p-2">
                                        <table>
                                            <tr>
                                                <td>
                                                    <a data-id="<?= $id ?>" data-soal-id="<?= $soal_1['lade_lath_id'] ?>" data-jawaban="d" class="btn btn-default btn-circle border">D</a>
                                                </td>
                                                    <td><?= $soal_1['lade_jawaban_d'] ?></td>
                                            </tr>
                                        </table>
                ...
                <div class="text-center">
                    ...
                    <span>1 dari 30</span>
                    <button class="btn btn-primary btn-icon-split float-right" id="konfirmasi">
...
<script>
    ...
    function load()
    {
        ...
        {
            if(data.href.includes('soal/test'))
            {
                data.href += '#soal'
            }
        })
